...
$lang = array(
    ...
    'nav_plans'                   => 'Plans',
    'main_navigation'             => 'Navigate',
    'forgot_password_title'       => 'Reset password',
    'forgot_password_body'        => 'Enter your account email and we will send a reset code.',
    'forgot_password_submit'      => 'Send reset code',
    'reset_password_title'        => 'Set new password',
    'reset_password_body'         => 'Enter the code from your email and choose a new password.',
    'reset_password_submit'       => 'Reset password',
    'back_to_login'               => 'Back to sign in',
    'confirm_password'            => 'Confirm password',
    'password_min'                => 'Password must be at least 8 characters.',
    'password_mismatch'           => 'Passwords do not match.',
    'invalid_email'               => 'No account found for this email.',
    'code_expired'                => 'Code expired. Request a new one.',
    'otp_digit_label'             => 'Reset code',
    'back'                        => 'Back',
    'receive_title'               => 'Receive files',
    'receive_subtitle'            => 'Paste a transfer link or ID to download shared files.',
    'receive_link_label'          => 'Transfer link or ID',
    'receive_link_placeholder'    => 'https://… or upload ID',
    'receive_private_id'          => 'Private ID (optional)',
    'receive_private_placeholder' => 'For email shares',
    'receive_load'                => 'Load transfer',
    'receive_scan_qr'             => 'Scan QR code',
    'receive_scan_hint'           => 'Point your camera at the transfer QR code.',
    'how_to_receive'              => 'How to receive',
    'receive_step_1_title'        => 'Get the link',
    'receive_step_1_body'         => 'Ask the sender for their share link or QR code.',
    'receive_step_2_title'        => 'Paste or scan',
    'receive_step_2_body'         => 'Enter the link above or scan the QR code.',
    'receive_step_3_title'        => 'Download',
    'receive_step_3_body'         => 'Unlock with a password if needed, then download your files.',
    'settings_subtitle'           => 'Appearance, language, and account.',
    ...
    'settings_signed_out'         => 'Sign in to sync transfer history across devices.',
    'settings_links'              => 'Links',
    'terms'                       => 'Terms of service',
    'about'                       => 'About',
    'register'                    => 'Create account',
    'scan_qr'                     => 'Scan to download',
    'share_qr_code'               => 'Download QR image',
    'guest_history_title'         => 'Recent transfers on this device',
    'sign_in_otp'                 => 'Sign in with email',
);